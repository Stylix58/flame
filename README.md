...
Run in an terminal (You need to have sudo rights): `wget https://raw.githubusercontent.com/Stylix58/flame/main/install.sh ; sudo chmod +x install.sh ; sudo sh ./install.sh`.
